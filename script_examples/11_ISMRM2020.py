...
# =============================================================================
# Parameters
NII_FILE = "/home/faruk/gdrive/test_brainsplode4/ISMRMR2020/sub-03_ses-01_flow_artifact_mitigated_avg_T2star_masked.nii.gz"
MASK = "/home/faruk/gdrive/test_brainsplode4/ISMRMR2020/sub-03_ses-01_brain_mask_rim_columns.nii.gz"
...
for i in uniq[0:-1]:  # Big numbers explode first
    ...
    p_velo_new[:, 0] = (np.random.rand(nr_new_part) + 0.75) * -2
