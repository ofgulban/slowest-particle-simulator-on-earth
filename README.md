...
`slowest_particle_simulator_on_earth` creates individual pictures which can be compiled into an animated gif. I use the following `ffmpeg` command (on linux) to convert the frames into animated gifs:
